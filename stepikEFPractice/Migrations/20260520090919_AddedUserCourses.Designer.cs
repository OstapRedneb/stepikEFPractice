...
namespace stepikEFPractice.Migrations
{
    ...
    [Migration("20260520090919_AddedUserCourses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stepikEFPractice.Models.Lesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("stepikEFPractice.Models.Step", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseUser", b =>
                {
                    ...
                    b.HasOne("stepikEFPractice.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LessonUnit", b =>
                {
                    b.HasOne("stepikEFPractice.Models.Lesson", null)
                        .WithMany()
                        .HasForeignKey("LessonsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("stepikEFPractice.Models.Unit", null)
                        .WithMany()
            ...
            modelBuilder.Entity("stepikEFPractice.Models.Step", b =>
                {
                    b.HasOne("stepikEFPractice.Models.Lesson", "Lesson")
                        .WithMany("Steps")
